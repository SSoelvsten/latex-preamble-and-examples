...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setvalue{title = Keep Calm and setTitle}
\setvalue{subtitle = }
...
\setvalue{name = Steffan Sølvsten}
\setvalue{email = 201505832@post.au.dk}
\setvalue{id = au534068}

\DeclareDocumentCommand \addauth { m g g }{ 			% \setAuth{name}{email}{id}
	 \setvalue{name = #1}
	 \author{\getvalue{name}}
	 \IfValueT {#2} {
	 	\setvalue{email = #2}
	 	\affil{\protect\href{mailto:\getvalue{email}}{\getvalue{email}}}
	 }
	 \IfValueT {#3} {
	 	\setvalue{id = #3}
	 }
