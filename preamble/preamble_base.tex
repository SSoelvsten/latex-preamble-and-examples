...
\DeclarePairedDelimiter\ceil{\left\lceil}{\right\rceil}        % ceil{arg}
\DeclarePairedDelimiter\floor{\left\lfloor}{\right\rfloor}     % floor{arg}
\DeclarePairedDelimiter\abs{\left\lvert}{\right\rvert}         % abs{arg}
