...
\usepackage{amsmath,amssymb,bm,mathtools}		% various basic mathtools
\usepackage{tabularx,booktabs,authblk}		    % various basic stuff for tables and more

% Link: \url{link} for synlige links og \href{link}{text} for links i text
...
% Tikz package for cool graphics
...
% Macro for circle with number in it.
%\newcommand*\circled[1]{ \tikz[baseline=(C.base)]\node[draw,circle,inner sep=0.5pt](C) {#1};\!}

% Quotations - Is set to danish style (british for english).
...
\newcommand{\dy}{\mathop{}\,\mathrm{d}y}            % \dy
\newcommand{\e}{\mathrm{e}}                         % \e = eulers number
\newcommand{\R}{\mathbb{R}}                         % \R = reals
\newcommand{\N}{\mathbb{N}}                         % \N = Real numbers
