...
% Define title and more on frontpage
    \title{\huge Examples Document \\ \large Reverse engineerable \LaTeX}
...
If you need a fresh variable, you don't create a subproof, but instead a boxed subproof.
\begin{center}
	\fitchprf{
