...
Indføres en frisk variabel, så kan man vælge at gøre det med en subproof, men den korrekte notation lader til at være en boxed subproof.
\begin{center}
	\fitchprf{
...
Følgende er en figur som indeholder et billede. Figurens label er \ref{FigExample}. Figurer behøver dog ikke at indeholdet et billede og i stedet for \emph{includegraphics} kan alt muligt andet indsættes. Bare eksperimenter en smule.
...
Vil man dog lave en reference til litteraturlisten, så bruges \emph{cite} kommandoerne. Her er desuden en reference til litteratur \cite{berlog}, som er skrevet i \emph{bibliography} længere nedenunder. Dette er dog redefineret til litteratur i danskdelen ovenfor. Vil man have flere referencer samtidig, så skrives bare flere referencer som argumenter til \emph{cite}, så det ser sådan ud: \cite{berlog, steffan}
